# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-03-02 01:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='app',
            name='output',
            field=models.CharField(blank=True, choices=[('json', 'JSON'), ('yalm', 'YALM')], max_length=200, null=True),
        ),
        migrations.AlterField(
            model_name='app',
            name='product',
            field=models.CharField(blank=True, choices=[('rest', 'REST'), ('soap', 'SOAP'), ('websocket', 'WebSocket'), ('e-commerce', 'E-Commerce'), ('e-commerce-api', 'E-commerce API'), ('blog', 'Blog'), ('blog-api', 'Blog API'), ('personal-page', 'Personal Page')], default='', max_length=200),
        ),
        migrations.AlterField(
            model_name='app',
            name='technology',
